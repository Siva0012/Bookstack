    ...
    return (
        <div className='flex-col'>
            <div className='flex items-end mb-4'>
                <button onClick={handleClick} className='text-white px-5 py-1 rounded-sm bg-blue-500  me-auto '>Add book</button>
            </div>
                                ...
                                return (
                                    <>
                                        <tr key={book._id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                            ...
                                            <td className="px-6 py-4">
                                                {moment(book.dateAdded).format('MMMM Do YYYY, h:mm:ss a')}
                                            </td>
                                            <td className="px-6 py-4">
                                                {book.edition}
                                            </td>
                                            ...
                                            <td className="px-6 py-4">
                                                ...
                                                <button onClick={() => handleViewBook(book._id)} className='bg-indigo-600 w-[75px] text-white px-2 py-1 rounded-md hover:text-indigo-600 hover:drop-shadow-[0_4px_4px_rgba(0,0,0,0.2)]  hover:bg-white' >View</button>
                                                {
                                                    book.isAvailable ? 
                                                    (
                                                        <button onClick={() => handleRemove(book._id , book.isAvailable)} className='bg-yellow-500 w-[75px] ms-8 text-white px-2 py-1 rounded-md hover:text-yellow-500 hover:drop-shadow-[0_4px_4px_rgba(0,0,0,0.2)]  hover:bg-white' >unlist</button>
                                                    )
                                                    :(
                                                        <button onClick={() => handleRemove(book._id , book.isAvailable)} className='bg-yellow-500 w-[75px] ms-8 text-white px-2 py-1 rounded-md hover:text-yellow-500 hover:drop-shadow-[0_4px_4px_rgba(0,0,0,0.2)]  hover:bg-white' >list</button>
                                                    )
                                                }
                                                </div>
                                            </td>
