...
function RecentBooksCard({ bookData }) {
  return (
    <div
      id="card"
      className="p-4 mx-auto bg-white drop-shadow-[0_0px_8px_rgba(0,0,0,0.2)] w-[220px] md:w-[230px] lg:w-[280px]  rounded-xl"
    >
      ...
      >
        <div className="">
          <div id="hover-div" className="hover:text-user-to cursor-pointer">
            ...
            <h1 className="text-sm capitalize ">{bookData.title}</h1>
          </div>
